...
Product SHA locked: `7374820642fad52a6264c86df8632c3a630df592` on `cursor/autopilot-003-issue23-restack-cwa` (origin matches).
...
| Dynamic inspection (restack) | — | **PENDING** (source-only report exists at `d6c5ad3` for `776647f`) |
