...
DEFAULT_EVIDENCE: Dict[str, bool] = {
    ...
    ReadinessCheck.DIRTY_CORE_CLEANED.value: False,
    ReadinessCheck.DIRTY_SERVER_CLEANED.value: False,
...
_CHECK_CONFIG: Tuple[Tuple[ReadinessCheck, bool, bool, str, str], ...] = (
    ...
    (
        ...
        True,
        True,
        "project_guardian/core.py quarantined hunks cleaned or safely committed",
    ...
    (
        ...
        True,
        True,
        "elysia/api/server.py quarantined hunks cleaned or safely committed",
