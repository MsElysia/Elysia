...
from .modules import debugger, memory, memory_condense, operator_chat, planner, router, summarizer, tool_selection
...
MODULES: Final[Dict[str, ModuleRecord]] = {
    ...
    "operator_chat": (operator_chat.MODULE_META, operator_chat.MODULE_TEXT),
