...
**Related docs:** [`LIMITED_LIVE_PROFILE.md`](LIMITED_LIVE_PROFILE.md), [`LIVE_READINESS_AFTER_APPROVAL_ROUTE_WIRING.md`](LIVE_READINESS_AFTER_APPROVAL_ROUTE_WIRING.md), [`APPROVAL_ROUTE_EXECUTOR_WIRING_IMPLEMENTATION.md`](APPROVAL_ROUTE_EXECUTOR_WIRING_IMPLEMENTATION.md)
